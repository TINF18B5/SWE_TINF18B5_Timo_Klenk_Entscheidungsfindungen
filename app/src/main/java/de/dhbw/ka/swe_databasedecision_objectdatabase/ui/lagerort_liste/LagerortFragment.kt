 ...
 */
class LagerortFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                val values = DataAccess.boxStore.boxFor(Lagerort::class.java).all
                adapter = MyLagerortRecyclerViewAdapter(values)
            }
        }
        return view
    }
